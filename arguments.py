...
class Arguments:
    ...
    def add_args(self):
        ...
        self.add_argument('--base_dir', type=str, default='Priyansh-Rishav/lmeraser/Dataset_Download/dataset_dir/g12/huangqidong/')
        ...
        ### prompt related
        self.add_argument('--pretrained_model', type=str, default='TinyLlama', choices=MODEL_LIST,help="Select a model to make unlearing")
